        ...
        try{
           ...
           /* DateTimeFormatter formatter = DateTimeFormatter.ofPattern("dd.MM.yyyy");
            ...
            String content = "<h1> You returned an item! </h1>"
                    ...
                    + "<p>Thank you for returning your borrowed item without any damage!</p>";
            String receiver = stdntEmail;
            String subject = "You returned an item without damage";

            Mail.send(receiver, subject, content);
            Mail.send("clemens.martin@moodle-dhbw.de", "Student "+stdntName+" returned an item without damage", content);
        } catch (Exception e) {
