...
$strName = "Current Rentals:";
echo $OUTPUT->heading($strName);

echo '<br>';
$tasks = get_tasks_by_key("hardwarerental.check_damage");
$table = new html_table();
$table->head = array('Name', 'Resource', 'Due date', 'Status', 'Details');
...
foreach ($tasks as $task) {
    ...
    $detailButton = $OUTPUT->single_button(new moodle_url('./lab_rentaldetail_view.php', array('id' => $cm->id, 'taskid' => $taskId)), 'Details', $attributes = null);
